...
void SoundManager::PlayFire(Vector2f emitterLoaction, Vector2f listenerLocation)
{
	Listener::setPosition(listenerLocation.x, listenerLocation.y, 0.0f);
	switch (m_NextSound)
	{
	case 1:
		m_Fire1Sound.setPosition(emitterLoaction.x, emitterLoaction.y, 0.0f);
		...
		break;
	case 2:
		m_Fire2Sound.setPosition(emitterLoaction.x, emitterLoaction.y, 0.0f);
		...
		break;
	case 3:
		m_Fire3Sound.setPosition(emitterLoaction.x, emitterLoaction.y, 0.0f);
